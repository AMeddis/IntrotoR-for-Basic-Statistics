...
#------------------------------------------------------------------------
#                             Question 4
# Calculate the mean of the biomarker value in each group by visit 
# Save results for the 2 groups (you need them for Question 5)
#-------------------------------------------------------------------------
...
#  Hint: initially plot the mean for group A and set the color in red
#        successively you can add the points for the means of group B with 
#        function points()
#  ADD the legend
#-------------------------------------------------------------------------
